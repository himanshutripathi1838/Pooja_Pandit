...
export default function Header({ activeTab, setActiveTab, language, setLanguage }: HeaderProps) {
  ...
  return (
    <>
      <header className="fixed top-0 w-full z-50 bg-[#fbf9f8]/80 backdrop-blur-xl border-b-[0.5px] border-[#e2bfb0]/30 shadow-sm h-20 flex justify-between items-center px-6 md:px-12 transition-all duration-300">
        {/* Left logo */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <button
              ...
              className="px-4 py-1.5 rounded-full border border-[#a04100]/20 bg-white hover:bg-[#ffdbcc]/10 text-xs font-semibold text-[#a04100] transition-all cursor-pointer flex items-center gap-2 shadow-xs active:scale-95"
            >
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-60 bg-black/40 backdrop-blur-sm transition-opacity" onClick={() => setMobileMenuOpen(false)}>
          <div 
            className="fixed top-0 left-0 bottom-0 w-72 bg-[#fbf9f8] shadow-2xl flex flex-col border-r border-[#e2bfb0]/20 p-6"
          ...
          >
            ...
            <div className="mb-4 p-4 bg-[#ffdbcc]/40 rounded-xl flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-sm text-[#a04100]">
                  {language === 'sa' ? 'धीरज त्रिपाठी' : language === 'te' ? 'ధీరజ్ త్రిపాఠి' : 'Dheeraj Tripathi'}
                </p>
                <p className="text-[10px] text-[#5a4136]/70 uppercase tracking-wider font-semibold">
            ...
            <div className="mb-4 p-1 bg-[#ffdbcc]/20 border border-[#e2bfb0]/10 rounded-xl">
                  ...
                  <button
                    ...
                    className={`px-2 py-1.5 rounded-lg text-center text-[11px] font-semibold transition-all cursor-pointer ${
                      language === lang.code 
                        ...
                        : 'text-[#5a4136] hover:bg-[#ffdbcc]/40 bg-white/40'
                    }`}
                  >
                    {lang.label}
                  </button>
                  ...
                  <a
                    ...
                    className={`flex items-center justify-between p-3 rounded-xl font-medium text-left text-sm transition-all ${
                      isActive 
                        ...
                        : 'text-[#5a4136] hover:bg-[#ffdbcc]/20'
                    }`}
                  >
            ...
            <div className="mt-auto pt-4 border-t border-[#e2bfb0]/20 text-center">
              <p className="text-[10px] text-[#5a4136]/50">
