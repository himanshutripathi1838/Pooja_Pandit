...
export const TRANSLATIONS: Record<string, Record<Language, any>> = {
  ...
  'seo.desc.contact': {
    en: 'Get in touch with Pandit Dheeraj Tripathi for customized Mahayagnas, astrological charts, gotra requirements, or booking queries.',
    hi: 'विशिष्ट महायज्ञों, जन्म कुंडली, गोत्र आवश्यकताओं या बुकिंग प्रश्नों के लिए पंडित धीरज त्रिपाठी से संपर्क करें।',
    sa: 'विशिष्टमहायज्ञानाम्, कुण्डलीविवरणस्य, गोत्रसम्बन्धिप्रश्नानां च कृते आचार्येण सह सम्पर्कं कुरु।',
    mr: 'महायज्ञ, जन्मपत्रिका, गोत्र आवश्यकता किंवा बुकिंग चौकशीसाठी पंडित धीरज त्रिपाठी यांच्याशी संपर्क साधा.',
    gu: 'મહાયજ્ઞો, જ્યોતિષીય ચાર્ટ, ગોત્ર આવશ્યકતાઓ અથવા બુકિંગ પૂછપરછ માટે પંડિત ધીરજ ત્રિપાઠીનો સંપર્ક કરો.',
    te: 'కస్టమ్ మహాయజ్ఞాలు, జాతక చక్రాలు లేదా బుకింగ్ ప్రశ్నల కోసం పండిట్ ధీరజ్ త్రిపాఠి గారిని సంప్రదించండి.',
