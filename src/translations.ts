...
export const TRANSLATIONS: Record<string, Record<Language, any>> = {
  ...
  'seo.desc.faq': {
    en: 'Find answers about puja samagri, cancellation policies, online e-pujas, and how to verify our certified Vedic Pandits.',
    hi: 'पूजा सामग्री, रद्दीकरण नीतियां, ऑनलाइन ई-पूजा, और हमारे प्रमाणित वैदिक पंडितों के सत्यापन के बारे में उत्तर प्राप्त करें।',
    sa: 'पूजासामग्री-सङ्कल्प-मङ्गलकालनिर्धारणादीनां प्रश्नानाम् उत्तराणि अत्र प्राप्नुवन्तु।',
    mr: 'पूजा साहित्य, रद्द करण्याचे धोरण, ऑनलाइन ई-पूजा आणि आमच्या प्रमाणित पंडितांच्या पडताळणीबद्दल उत्तरे शोधा.',
    gu: 'પૂજા સામગ્રી, રદ કરવાની નીતિઓ, ઓનલાઇન ઈ-પૂજા અને અમારા પ્રમાણિત પંડિતોની ચકાસણી વિશે જવાબો મેળવો.',
    te: 'పూజా సామాగ్రి, రద్దు విధానాలు, ఆన్‌లైన్ ఇ-పూజలు మరియు పండితుల వివరాల సమాచారం.',
    ta: 'பூஜை பொருட்கள், ரத்து கொள்கைகள், ஆன்லைன் மின்-பூஜைகள் பற்றிய கேள்விகளுக்கான பதில்களைக் கண்டறியவும்.'
  },
  'seo.title.blog': {
    en: 'Vedic Wisdom Blog & Ritual Guides',
    hi: 'वैदिक ज्ञान ब्लॉग और अनुष्ठान मार्गदर्शिका',
    sa: 'वैदिकज्ञानलेखमाला शास्त्रचर्चा च',
    mr: 'वैदिक ज्ञान ब्लॉग आणि विधी मार्गदर्शिका',
    gu: 'વૈદિક જ્ઞાન બ્લોગ અને વિધિ માર્ગદર્શિકા',
    te: 'వైదిక జ్ఞాన బ్లాగ్ & క్రతువుల గైడ్లు',
    ta: 'வேத ஞான வலைப்பதிவு & சடங்கு வழிகாட்டிகள்'
  },
  'seo.desc.blog': {
    en: 'Read articles about the spiritual significance of Griha Pravesh, benefits of Rudrabhishek, and correct rituals of Hindu ceremonies.',
    hi: 'गृह प्रवेश के आध्यात्मिक महत्व, रुद्राभिषेक के लाभ और हिंदू अनुष्ठानों के सही विधि-विधान के बारे में लेख पढ़ें।',
    sa: 'गृहप्रवेशस्य आध्यात्मिकमहत्त्वम्, रुद्राभिषेकस्य लाभाः, वैदिकसंस्कृतेः चर्चा च अत्र पठन्तु।',
    mr: 'गृहप्रवेशाचे आध्यात्मिक महत्त्व, रुद्राभिषेकाचे फायदे आणि हिंदू विधींच्या योग्य पद्धतींबद्दल लेख वाचा.',
    gu: 'ગૃહપ્રવેશના આધ્યાત્મિક મહત્વ, રુદ્રાભિષેકના ફાયદા અને હિન્દુ વિધિઓની સાચી પદ્ધતિઓ વિશે લેખો વાંચો.',
    te: 'గృహ ప్రవేశం యొక్క ప్రాముఖ్యత, రుద్రాభిషేకం ప్రయోజనాలు మరియు ఇతర వైదిక విషయాలపై వ్యాసాలు చదవండి.',
    ta: 'கிருஹ பிரவேசத்தின் ஆன்மீக முக்கியத்துவம், ருத்ராபிஷேகத்தின் நன்மைகள் பற்றிய கட்டுரைகளை வாசியுங்கள்.'
  },
  'seo.title.contact': {
    en: 'Contact Us | Custom Puja Queries',
    hi: 'संपर्क करें | कस्टम पूजा पूछताछ',
    sa: 'अस्माभिः सह सम्पर्कं कुरु',
    mr: 'संपर्क साधा | सानुकूलित पूजा चौकशी',
    gu: 'સંપર્ક કરો | વૈવિધ્યપૂર્ણ પૂજા પૂછપરછ',
    te: 'సంప్రదించండి | కస్టమ్ పూజా ప్రశ్నలు',
    ta: 'தொடர்பு கொள்ளவும் | தனிப்பயன் பூஜை கேள்விகள்'
  },
  'seo.desc.contact': {
    en: 'Get in touch with Pandit Dhirendra Shastri Ji for customized Mahayagnas, astrological charts, gotra requirements, or booking queries.',
    hi: 'विशिष्ट महायज्ञों, जन्म कुंडली, गोत्र आवश्यकताओं या बुकिंग प्रश्नों के लिए पंडित धीरेंद्र शास्त्री जी से संपर्क करें।',
    sa: 'विशिष्टमहायज्ञानाम्, कुण्डलीविवरणस्य, गोत्रसम्बन्धिप्रश्नानां च कृते आचार्येण सह सम्पर्कं कुरु।',
    mr: 'महायज्ञ, जन्मपत्रिका, गोत्र आवश्यकता किंवा बुकिंग चौकशीसाठी पंडित धीरेंद्र शास्त्री जी यांच्याशी संपर्क साधा.',
    gu: 'મહાયજ્ઞો, જ્યોતિષીય ચાર્ટ, ગોત્ર આવશ્યકતાઓ અથવા બુકિંગ પૂછપરછ માટે પંડિત ધીરજ ત્રિપાઠીનો સંપર્ક કરો.',
    te: 'కస్టమ్ మహాయజ్ఞాలు, జాతక చక్రాలు లేదా బుకింగ్ ప్రశ్నల కోసం పండిట్ ధీరేంద్ర శాస్త్రి జీ గారిని సంప్రదించండి.',
    ta: 'தனிப்பயனாக்கப்பட்ட யாகங்கள், ஜோதிட விளக்கப்படங்கள் அல்லது முன்பதிவு கேள்விகளுக்கு பண்டித தீரஜ் திரிபாதியைத் தொடர்பு கொள்ளவும்.'
  },
  'seo.title.privacy': {
    en: 'Privacy Policy | PujaPandit.tech',
    hi: 'गोपनीयता नीति | PujaPandit.tech',
    sa: 'गोपनीयता नीतिः | PujaPandit.tech',
    mr: 'गोपनीयता धोरण | PujaPandit.tech',
    gu: 'ગોપનીયતા નીતિ | PujaPandit.tech',
    te: 'వ్యక్తిగత గోప్యత విధానం',
    ta: 'தனியுரிமைக் கொள்கை'
  },
  'seo.desc.privacy': {
    en: 'Privacy guidelines, data usage, and user protection details for booking Vedic services.',
    hi: 'वैदिक सेवाओं की बुकिंग के लिए गोपनीयता दिशानिर्देश, डेटा उपयोग और उपयोगकर्ता सुरक्षा विवरण।',
    sa: 'पूजासङ्कल्पसेवाप्रदानाय प्रयोक्तृणां तथ्यसुरक्षायाः नियमाः।',
    mr: 'वैदिक सेवांच्या बुकिंगसाठी गोपनीयता मार्गदर्शक तत्त्वे, डेटा वापर आणि वापरकर्ता संरक्षण तपशील.',
    gu: 'વૈદિક સેવાઓના બુકિંગ માટે ગોપનીયતા માર્ગદર્શિકા, ડેટા વપરાશ અને વપરાશકર્તા સુરક્ષા વિગતો.',
    te: 'పూజా సేవల బుకింగ్ కోసం గోప్యతా మార్గదర్శకాలు మరియు వినియోగదారు రక్షణ వివరాలు.',
    ta: 'வேத சேவைகளை முன்பதிவு செய்வதற்கான தனியுரிமை வழிகாட்டுதல்கள் மற்றும் பயனர் பாதுகாப்பு விவரங்கள்.'
  },
  'seo.title.terms': {
    en: 'Terms & Conditions | PujaPandit.tech',
    hi: 'नियम और शर्तें | PujaPandit.tech',
    sa: 'सेवाशर्त्ताः | PujaPandit.tech',
    mr: 'नियम आणि अटी | PujaPandit.tech',
    gu: 'નિયમો અને શરતો | PujaPandit.tech',
    te: 'నిబంధనలు & షరతులు',
    ta: 'விதிமுறைகள் மற்றும் நிபந்தனைகள்'
  },
  'seo.desc.terms': {
    en: 'Terms of service, scheduling rules, and cancellation policies for booking verified priests.',
    hi: 'सत्यापित पंडितों की बुकिंग के लिए सेवा की शर्तें, शेड्यूलिंग नियम और रद्दीकरण नीतियां।',
    sa: 'पुरोहितसङ्कल्पाय सेवायाः नियमाः, कालपरिवर्तनं निरस्तीकरणविधयश्च।',
    mr: 'प्रमाणित पंडितांच्या बुकिंगसाठी सेवा अटी, वेळापत्रक नियम आणि रद्द करण्याचे धोरण.',
    gu: 'પ્રમાણિત પંડિતોના બુકિંગ માટે સેવાની શરતો, સમયપત્રકના નિયમો અને રદ કરવાની નીતિઓ.',
    te: 'పండితుల బుకింగ్ కోసం సేవా నిబంధనలు, షెడ్యూలింగ్ నియమాలు మరియు రద్దు విధానాలు.',
    ta: 'சான்றளிக்கப்பட்ட பண்டிதர்களை முன்பதிவு செய்வதற்கான சேவை விதிமுறைகள் மற்றும் ரத்து கொள்கைகள்.'
  },
  ...
  'seo.desc.home': {
    ...
    hi: 'प्रामाणिक वैदिक अनुष्ठान, हवन और ज्योतिष परामर्श ऑनलाइन बुक करें। वाराणसी और वैश्विक स्तर पर पंडित धीरेंद्र शास्त्री जी द्वारा पूर्ण शास्त्रीय शुद्धता के साथ संपन्न।',
    sa: 'प्रामाणिकवैदिकयज्ञ-पूजा-ज्योतिषपरामर्शाः। आचार्य धीरेंद्र शास्त्री जी इत्यनेन शास्त्रोक्तविधिना सम्पाद्यते।',
    mr: 'अधिकृत वैदिक विधी, हवन आणि ज्योतिष सल्ला ऑनलाइन बुक करा. पंडित धीरेंद्र शास्त्री जी यांच्याद्वारे पूर्ण शास्त्रीय शुद्धतेने संपन्न.',
    gu: 'વૈદિક વિધિઓ, હવન અને જ્યોતિષ સલાહ ઓનલાઇન બુક કરો. પંડિત ધીરજ ત્રિપાઠી દ્વારા પૂર્ણ શાસ્ત્રીય શુદ્ધતા સાથે સંપન્ન.',
    te: 'అధికారిక వైదిక క్రతువులు, హవనాలు మరియు జ్యోతిష్య సంప్రదింపులను ఆన్‌లైన్‌లో బుక్ చేయండి. పండిట్ ధీరేంద్ర శాస్త్రి జీ గారిచే నిర్వహించబడును.',
  ...
  'seo.title.about': {
    en: 'About Pandit Dhirendra Shastri Ji | Vedic Priest',
    hi: 'पंडित धीरेंद्र शास्त्री जी का परिचय | वैदिक पुरोहित',
    sa: 'आचार्य धीरेंद्र शास्त्री जी परिचयः | वैदिक पुरोहितः',
    mr: 'पंडित धीरेंद्र शास्त्री जी यांच्याबद्दल | वैदिक पुरोहित',
    gu: 'પંડિત ધીરજ ત્રિપાઠી વિશે | વૈદિક પુરોહિત',
    te: 'పండిట్ ధీరేంద్ర శాస్త్రి జీ గారి గురించి | వైదిక పూజారి',
    ta: 'பண்டித தீரஜ் திரிபாதி பற்றி | வேத பூசாரி'
  },
  'seo.desc.about': {
    en: 'Learn about the 7-generation Sanskrit lineage, Vedic education in Varanasi, and ritual experiences of Pandit Dhirendra Shastri Ji.',
    hi: 'काशी में शिक्षित, सात पीढ़ियों की पुरोहित परंपरा और पंडित धीरेंद्र शास्त्री जी के वैदिक कर्मकांड अनुभवों के बारे में जानें।',
    sa: 'वाराणस्यां लब्धदीक्षः, सप्तवंशपरम्परागत पुरोहितः आचार्य धीरेंद्र शास्त्री जी महोदयस्य परिचयः।',
    mr: 'काशीमध्ये शिक्षित, सात पिढ्यांची पुरोहित परंपरा आणि पंडित धीरेंद्र शास्त्री जी यांच्या वैदिक कर्मकांडाच्या अनुभवांबद्दल जाणून घ्या.',
    gu: 'વારાણસીમાં શિક્ષિત, સાત પેઢીઓની પુરોહિત પરંપરા અને પંડિત ધીરજ ત્રિપાઠીના વૈદિક કર્મકાંડના અનુભવો વિશે જાણો.',
    te: 'వారణాసిలో వైదిక విద్య, ఏడు తరాల పూజారి వంశం మరియు పండిట్ ధీరేంద్ర శాస్త్రి జీ గారి సేవల గురించి తెలుసుకోండి.',
  ...
  'nav.blog': {
    ...
    mr: 'वैदिक ब्लॉग',
    gu: 'વૈદિક બ્લોગ',
    te: 'ఆధ్యాత్మిక బ్లాగ్',
    ta: 'ஆன்மீக வலைப்பதிவு'
  },
  'nav.contact': {
    en: 'Contact Us',
    hi: 'संपर्क करें',
  ...
  // About View
  'about.title': {
    en: 'Pandit Dhirendra Shastri Ji',
    hi: 'धीरेंद्र शास्त्री जी',
    sa: 'धीरेंद्र शास्त्री जी',
    mr: 'धीरेंद्र शास्त्री जी',
    gu: 'ધીરજ ત્રિપાઠી',
    te: 'ధీరేంద్ర శాస్త్రి జీ',
    ta: 'Pandit Dhirendra Shastri Ji'
  },
  'about.subtitle': {
  ...
  'about.hero.title': {
    en: 'PANDIT DHIRENDRA SHASTRI JI',
    hi: 'पंडित धीरेंद्र शास्त्री जी',
    sa: 'पण्डित-धीरेन्द्रशास्त्रिमहोदयः',
    mr: 'पंडित धीरेंद्र शास्त्री जी',
    gu: 'પંડિત ધીરેન્દ્ર શાસ્ત્રીજી',
    te: 'పండిట్ ధీరేంద్ర శాస్త్రి జీ',
    ta: 'பண்டிட் தீரேந்திர சாஸ்திரி ஜி'
  },
  'about.hero.desc': {
  ...
  'home.cta.subtitle': {
    en: 'Seek high-fidelity astrological consultation or book a fully personalized sacred ritual directly with Pandit Dhirendra Shastri Ji.',
    hi: 'आचार्य धीरेंद्र शास्त्री जी से ज्योतिषीय परामर्श लें या अपने घर पर पूर्णतः अनुकूलित वैदिक अनुष्ठान संपन्न करवाएं।',
    sa: 'आचार्य धीरेंद्र शास्त्री जी इत्यस्य मार्गदर्शनेन स्वगृहमुहूर्त्तम् वैयक्तिकपूजां वा सम्पादयन्तु।',
    mr: 'पंडित धीरेंद्र शास्त्री जी यांच्याकडून ज्योतिष सल्ला घ्या किंवा आपल्या घरी पूजा विधी संपन्न करा.',
    gu: 'પંડિત ધીરજ ત્રિપાઠી પાસેથી જ્યોતિષ સલાહ મેળવો અથવા તમારા ઘરે પૂજા વિધિ કરાવો.',
    te: 'పండిట్ ధీరేంద్ర శాస్త్రి జీ గారిని సంప్రదించి, జాతక పరిశీలన లేదా మీ ఇంట్లో వైదిక పూజలు చేయించుకోండి.',
...
,
  ...
  'Auspicious astrological timing selection by Pandit Dhirendra Shastri Ji': { en: 'Auspicious astrological timing selection by Pandit Dhirendra Shastri Ji', hi: 'पंडित धीरेंद्र शास्त्री जी द्वारा शुभ मुहूर्त का चयन', sa: 'शुभमुहूर्त्तनिर्धारणम्', te: 'పండిట్ ధీరేంద్ర శాస్త్రి జీ గారి చేత ముహూర్త निर्णयం', ta: 'சுப முகூர்த்த நேரம் தேர்வு செய்தல்', mr: 'पंडित धीरेंद्र शास्त्री जी यांचेकडून मुहूर्त निवड', gu: 'પંડિત ધીરજ ત્રિપાઠી દ્વારા મુહૂર્ત પસંદગી' },
